...
//    gStyle->SetOptStat(0);
    ...
    for(int j = 0; j < CHNUM; j++){
        ...
        hist[j] = new TH2F(hist_name, hist_name, 1024, 0, 1024, 600, -200, 400);
    }
        ...
        for(int ch = 0; ch < CHNUM; ch++){
            ...
            if(DataLength != 0){
                ...
                for(int sample = 0; sample < 1024; sample++){
                    ...
                    hist[ch]->Fill(sample,get_data_final[ch][sample]);
                }
...
//        fprintf(w_fp, "%d %f %f %f %f %f\n", ch, sigma, sigmaErr, Chisquar, RMS, RMSErr);
		...
		Canvas->SaveAs("check_baseline.png");
//    Canvas->Update();
